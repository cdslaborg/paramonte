...
function(matlab_add_mex)
  ...
  if(NOT Matlab_VERSION_STRING VERSION_LESS "9.1") # For 9.1 (R2016b) and newer, add version source file
    ...
    if(CMAKE_Fortran_COMPILER_LOADED)
      # If Fortran is enabled, use the .F file
    ...
    elseif(CMAKE_CXX_COMPILER_LOADED)
      ...
      # If neither C, CXX or Fortran is enabled, warn because we cannot add the source.
      # TODO: add support for fortran mex files
      message(WARNING "[MATLAB] matlab_add_mex requires that at least C, CXX or Fortran are enabled languages")
    endif()
  endif()
