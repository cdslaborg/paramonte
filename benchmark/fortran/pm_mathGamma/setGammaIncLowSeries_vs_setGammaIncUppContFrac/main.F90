! Test the performance of `setGammaIncLowSeries()` vs. `setGammaIncUppContFrac()`.
program benchmark
...
contains
    ...
    subroutine setGammaIncLowSeries()
        block
            use pm_mathGamma, only: setGammaIncLowSeries
            call setGammaIncLowSeries   ( gammaIncLow = gammaInc &
                                        , x = Point(ipnt) &
    ...
    subroutine setGammaIncUppContFrac()
        block
            use pm_mathGamma, only: setGammaIncUppContFrac
            call setGammaIncUppContFrac ( gammaIncUpp = gammaInc &
                                        , x = Point(ipnt) &
                                        , logGammaKappa = logGammaKappa &
                                        , kappa = kappa &
                                        , info = info &
