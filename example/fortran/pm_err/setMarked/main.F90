program example
    ...
    call disp%show("call setMarked(str, newline = SK_'\n', unit = disp%unit)")
                    call setMarked(str, newline = SK_'\n', unit = disp%unit)
    call disp%skip()
    call disp%show("call setMarked(str, prefix = SK_'    ParaMonte: ', newline = SK_'\n', unit = disp%unit)")
                    call setMarked(str, prefix = SK_'    ParaMonte: ', newline = SK_'\n', unit = disp%unit)
    call disp%skip()
