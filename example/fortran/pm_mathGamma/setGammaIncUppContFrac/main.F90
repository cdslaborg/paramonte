program example
    ...
    call disp%show( kappa_RKS )
    call disp%show("call setGammaIncUppContFrac(gamIncUpp_RKS, x_RKS, logGammaKappa = log_gamma(kappa_RKS), kappa = kappa_RKS, info = info)")
    ...
    call disp%show( kappa_RKD)
    call disp%show("call setGammaIncUppContFrac(gamIncUpp_RKD, x_RKD, logGammaKappa = log_gamma(kappa_RKD), kappa = kappa_RKD, info = info)")
    ...
    call disp%show( kappa_RKH )
    call disp%show("call setGammaIncUppContFrac(gamIncUpp_RKH, x_RKH, logGammaKappa = log_gamma(kappa_RKH), kappa = kappa_RKH, info = info)")
    ...
    block
        ...
        do i = 1, NP
            call setGammaIncUppContFrac(gamIncUpp_RKS, x_RKS(i), logGammaKappa = log_gamma(kappa_RKS), kappa = kappa_RKS, info = info)
