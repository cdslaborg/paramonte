program example
    ...
    block
        ...
        call disp%show( getVar(sample) )
        call disp%show("call setScaled(sample, 1._TKC / sqrt(getVar(sample)))")
                        call setScaled(sample, 1._TKC / sqrt(getVar(sample)))
        call disp%show("sample")
        call disp%show( sample )
        call disp%show("getVar(sample)")
        call disp%show( getVar(sample) )
    ...
    block
        ...
        call disp%show( getVar(sample, dim) )
        call disp%show("call setScaled(sample, dim, 1._TKC / sqrt(getVar(sample, dim)))")
                        call setScaled(sample, dim, 1._TKC / sqrt(getVar(sample, dim)))
        call disp%show("sample")
        call disp%show( sample )
        call disp%show("getVar(sample, dim)")
        call disp%show( getVar(sample, dim) )
