program example
    ...
    call disp%show("call setRankStandard(Rank, string_SK)")
                    call setRankStandard(Rank, string_SK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("call setRankStandard(Rank, Vector_SK)")
                    call setRankStandard(Rank, Vector_SK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show( Vector_IK )
    call disp%show("call setRankStandard(Rank, Vector_IK)")
                    call setRankStandard(Rank, Vector_IK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show( Vector_LK )
    call disp%show("call setRankStandard(Rank, Vector_LK)")
                    call setRankStandard(Rank, Vector_LK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show( Vector_RK )
    call disp%show("call setRankStandard(Rank, Vector_RK)")
                    call setRankStandard(Rank, Vector_RK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("Vector_IK")
    call disp%show( Vector_IK )
    call disp%show("call setRankStandard(Rank, Vector_IK, isSorted_IK)")
                    call setRankStandard(Rank, Vector_IK, isSorted_IK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("Vector_RK")
    call disp%show( Vector_RK )
    call disp%show("call setRankStandard(Rank, Vector_RK, isSorted_RK)")
                    call setRankStandard(Rank, Vector_RK, isSorted_RK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    call disp%show("call setRankStandard(Rank, string_SK, isSortedChar1)")
                    call setRankStandard(Rank, string_SK, isSortedChar1)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    call disp%show("call setRankStandard(Rank, string_SK, isSortedChar2)")
                    call setRankStandard(Rank, string_SK, isSortedChar2)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("call setRankStandard(Rank, cssvec)")
                    call setRankStandard(Rank, cssvec)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
#endif
