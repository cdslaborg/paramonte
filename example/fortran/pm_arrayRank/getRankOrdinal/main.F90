program example
    ...
    call disp%show("Rank = getRankOrdinal(string_SK)")
                    Rank = getRankOrdinal(string_SK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("Rank = getRankOrdinal(Vector_SK)")
                    Rank = getRankOrdinal(Vector_SK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show( Vector_IK )
    call disp%show("Rank = getRankOrdinal(Vector_IK)")
                    Rank = getRankOrdinal(Vector_IK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show( Vector_LK )
    call disp%show("Rank = getRankOrdinal(Vector_LK)")
                    Rank = getRankOrdinal(Vector_LK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show( Vector_RK )
    call disp%show("Rank = getRankOrdinal(Vector_RK)")
                    Rank = getRankOrdinal(Vector_RK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("Vector_IK")
    call disp%show( Vector_IK )
    call disp%show("Rank = getRankOrdinal(Vector_IK, isSorted_IK)")
                    Rank = getRankOrdinal(Vector_IK, isSorted_IK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("Vector_RK")
    call disp%show( Vector_RK )
    call disp%show("Rank = getRankOrdinal(Vector_RK, isSorted_RK)")
                    Rank = getRankOrdinal(Vector_RK, isSorted_RK)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    call disp%show("Rank = getRankOrdinal(string_SK, isSortedChar1)")
                    Rank = getRankOrdinal(string_SK, isSortedChar1)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    call disp%show("Rank = getRankOrdinal(string_SK, isSortedChar2)")
                    Rank = getRankOrdinal(string_SK, isSortedChar2)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
    ...
    call disp%show("Rank = getRankOrdinal(cssvec)")
                    Rank = getRankOrdinal(cssvec)
    call disp%show("Rank")
    call disp%show( Rank )
    call disp%skip()
#endif
