program example
    ...
    call disp%show("call setReplaced(string_SK, stringPattern_SK, stringReplacement_SK)")
                    call setReplaced(string_SK, stringPattern_SK, stringReplacement_SK)
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    ...
    call disp%show("call setReplaced(Array_SK, ArrayPattern_SK, ArrayReplacement_SK)")
                    call setReplaced(Array_SK, ArrayPattern_SK, ArrayReplacement_SK)
    call disp%show("Array_SK")
    call disp%show( Array_SK, deliml = SK_"""" )
    ...
    call disp%show( ArrayReplacement_LK )
    call disp%show("call setReplaced(Array_LK, ArrayPattern_LK, ArrayReplacement_LK)")
                    call setReplaced(Array_LK, ArrayPattern_LK, ArrayReplacement_LK)
    call disp%show("Array_LK")
    call disp%show( Array_LK )
    ...
    call disp%show( ArrayReplacement_IK )
    call disp%show("call setReplaced(Array_IK, ArrayPattern_IK, ArrayReplacement_IK)")
                    call setReplaced(Array_IK, ArrayPattern_IK, ArrayReplacement_IK)
    call disp%show("Array_IK")
    call disp%show( Array_IK )
    ...
    call disp%show( ArrayReplacement_CK )
    call disp%show("call setReplaced(Array_CK, ArrayPattern_CK, ArrayReplacement_CK)")
                    call setReplaced(Array_CK, ArrayPattern_CK, ArrayReplacement_CK)
    call disp%show("Array_CK")
    call disp%show( Array_CK )
    ...
    call disp%show( ArrayReplacement_RK )
    call disp%show("call setReplaced(Array_RK, ArrayPattern_RK, ArrayReplacement_RK)")
                    call setReplaced(Array_RK, ArrayPattern_RK, ArrayReplacement_RK)
    call disp%show("Array_RK")
    call disp%show( Array_RK )
    ...
    call disp%show( instance )
    call disp%show("call setReplaced(string_SK, stringPattern_SK, stringReplacement_SK, instance)")
                    call setReplaced(string_SK, stringPattern_SK, stringReplacement_SK, instance)
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    ...
    call disp%show("ArrayReplacement_SK")
    call disp%show( ArrayReplacement_SK, deliml = SK_"""" )
    call disp%show("call setReplaced(Array_SK, ArrayPattern_SK, ArrayReplacement_SK, instance)")
                    call setReplaced(Array_SK, ArrayPattern_SK, ArrayReplacement_SK, instance)
    call disp%show("Array_SK")
    call disp%show( Array_SK, deliml = SK_"""" )
    ...
    call disp%show("instance")
    call disp%show( instance )
    call disp%show("call setReplaced(Array_IK, ArrayPattern_IK, ArrayReplacement_IK, instance)")
                    call setReplaced(Array_IK, ArrayPattern_IK, ArrayReplacement_IK, instance)
    call disp%show("Array_IK")
    call disp%show( Array_IK )
    ...
    call disp%show("instance")
    call disp%show( instance )
    call disp%show("call setReplaced(Array_CK, ArrayPattern_CK, ArrayReplacement_CK, instance)")
                    call setReplaced(Array_CK, ArrayPattern_CK, ArrayReplacement_CK, instance)
    call disp%show("Array_CK")
    call disp%show( Array_CK )
    ...
    call disp%show("instance")
    call disp%show( instance )
    call disp%show("call setReplaced(Array_RK, ArrayPattern_RK, ArrayReplacement_RK, instance)")
                    call setReplaced(Array_RK, ArrayPattern_RK, ArrayReplacement_RK, instance)
    call disp%show("Array_RK")
    call disp%show( Array_RK )
    ...
    call disp%show("instance")
    call disp%show( instance )
    call disp%show("call setReplaced(Array_RK, ArrayPattern_RK, ArrayReplacement_RK, iseq = iseq_RK, instance = instance)")
                    call setReplaced(Array_RK, ArrayPattern_RK, ArrayReplacement_RK, iseq = iseq_RK, instance = instance)
    call disp%show("Array_RK")
    call disp%show( Array_RK )
    ...
    call disp%show("stringReplacement_SK")
    call disp%show( stringReplacement_SK, deliml = SK_"""" )
    call disp%show("call setReplaced(string_SK, stringPattern_SK, stringReplacement_SK, iseq = iseq_SK)")
                    call setReplaced(string_SK, stringPattern_SK, stringReplacement_SK, iseq = iseq_SK)
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    ...
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("! Call to setReplaced() preserves the lower bound of the input `Array`.")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%skip()
    ...
    deallocate(Array_IK)
    ArrayPattern_IK = [0_IK]
    ArrayReplacement_IK = [-999_IK, -999_IK]
    allocate(Array_IK(-7:-1), source = [1_IK, 0_IK, 2_IK, 0_IK, 3_IK, 0_IK, 4_IK])
    call disp%show("[lbound(Array_IK,1), ubound(Array_IK,1)]")
    call disp%show( [lbound(Array_IK,1), ubound(Array_IK,1)] )
    call disp%show("Array_IK")
    ...
    call disp%show("ArrayReplacement_IK")
    call disp%show( ArrayReplacement_IK )
    call disp%show("call setReplaced(Array_IK, ArrayPattern_IK, ArrayReplacement_IK, instance = instance)")
                    call setReplaced(Array_IK, ArrayPattern_IK, ArrayReplacement_IK, instance = instance)
    call disp%show("Array_IK")
    call disp%show( Array_IK )
    call disp%show("[lbound(Array_IK,1), ubound(Array_IK,1)]")
    call disp%show( [lbound(Array_IK,1), ubound(Array_IK,1)] )
