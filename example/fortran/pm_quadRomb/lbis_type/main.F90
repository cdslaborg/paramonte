program example
    ...
    call disp%show( quadref_DP )
    call disp%show("quad_DP = getQuadRomb(getBetaPDF_DP, 0._DP, .5_DP, epsilon(1._DP) * 100, 10_IK, lbis_type(real(alpha_DP) - 1.)) + getQuadRomb(getBetaPDF_DP, .5_DP, 1._DP, epsilon(1._DP) * 100, 5_IK, ubis_type(real(beta_DP) - 1.))")
    ...
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("! Compute the integral of 1/sqrt(abs(x)) = 4 over the interval [-1, 1] with a singularity at x = 0.")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%skip()
