program example
    ...
    use pm_quadpack, only: getQuadErr, GK41
    ...
    call disp%show("err = getQuadErr(getNormPDF, lb, ub, ABSTOL, RELTOL, GK41, integral, abserr, sinfo, sindex, neval, nint)")
    ...
    call disp%show("err = getQuadErr(getLogNormPDF, lb, ub, ABSTOL, RELTOL, GK41, integral, abserr, sinfo, sindex, neval, nint)")
