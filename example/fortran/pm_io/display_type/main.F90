program example
    ...
    call disp%skip()
    call disp%show("call disp%show('ParaMonte', deliml = '''') ! output with single quotation marks.")
                    call disp%show('ParaMonte', deliml = '''')
    call disp%skip()
    call disp%show('call disp%show("ParaMonte", deliml = """") ! output with double quotation marks.')
                    call disp%show('ParaMonte', deliml = """")
    call disp%skip()
    call disp%show('call disp%show("ParaMonte", deliml = "`") ! output with backtick marks.')
                    call disp%show('ParaMonte', deliml = "`")
    call disp%skip()
