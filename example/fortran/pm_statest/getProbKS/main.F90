program example
    ...
    block
        ...
        do itry = 1, ntry
            ...
            call disp%show( statKS )
            call disp%show("probKS = getProbKS(statKS, nsam1) ! assuming unweighted samples.")
                            probKS = getProbKS(statKS, nsam1) ! assuming unweighted samples.
            call disp%show("probKS")
            call disp%show( probKS )
            call disp%skip()
            ...
            call disp%show("statKS")
            call disp%show( statKS )
            call disp%show("probKS = getProbKS(statKS, sum(iweight1))")
            ...
            call disp%show("statKS")
            call disp%show( statKS )
            call disp%show("probKS = getProbKS(statKS, sum(rweight1), sum(rweight1**2))")
    ...
    block
        ...
        do itry = 1, ntry
            ...
            call disp%show("statKS")
            call disp%show( statKS )
            call disp%show("probKS = getProbKS(statKS, nsam1, nsam2) ! assuming unweighted samples.")
            ...
            call disp%show("statKS")
            call disp%show( statKS )
            call disp%show("probKS = getProbKS(statKS, sum(iweight1), nsam2)")
            ...
            call disp%show("statKS")
            call disp%show( statKS )
            call disp%show("probKS = getProbKS(statKS, sum(rweight1), nsam2, sum(rweight1**2))")
            ...
            call disp%show("statKS")
            call disp%show( statKS )
            call disp%show("probKS = getProbKS(statKS, sum(iweight1), sum(iweight2))")
                            probKS = getProbKS(statKS, sum(iweight1), sum(iweight2))
            call disp%show("probKS")
            call disp%show( probKS )
            call disp%show("probKS = getProbKS(statKS, sum(rweight1), sum(iweight2), sum(rweight1**2))")
            ...
            call disp%show("statKS")
            call disp%show( statKS )
            call disp%show("probKS = getProbKS(statKS, sum(rweight1), sum(rweight2), sum(rweight1**2), sum(rweight2**2))")
