program example
    ...
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("! Pad an array to the left with symbols.")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%skip()
    ...
    call disp%show( len(string_SK) )
    call disp%show("string_SK = getPaddedl(string_SK, lpsize = 5_IK, lpfill = SK_'-')")
                    string_SK = getPaddedl(string_SK, lpsize = 5_IK, lpfill = SK_'-')
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    call disp%show("len(string_SK)")
    call disp%show( len(string_SK) )
    ...
    call disp%show("len(string_SK)")
    call disp%show( len(string_SK) )
    call disp%show("string_SK = getPaddedl(string_SK, lpsize = 4_IK, lpfill = SK_' ', lmsize = 4_IK, lmfill = SK_'*')")
                    string_SK = getPaddedl(string_SK, lpsize = 4_IK, lpfill = SK_' ', lmsize = 4_IK, lmfill = SK_'*')
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    call disp%show("len(string_SK)")
    call disp%show( len(string_SK) )
    ...
    call disp%show([lbound(Array_SK), ubound(Array_SK)])
    call disp%show("Array_SK = getPaddedl(Array_SK, lpsize = 5_IK, lpfill = SK_'  ')")
                    Array_SK = getPaddedl(Array_SK, lpsize = 5_IK, lpfill = SK_'  ')
    call disp%show("Array_SK")
    call disp%show( Array_SK, deliml = SK_"""" )
    call disp%show("lbound(Array_SK), ubound(Array_SK)")
    call disp%show([lbound(Array_SK), ubound(Array_SK)])
    ...
    call disp%show([lbound(Array_LK), ubound(Array_LK)])
    call disp%show("Array_LK = getPaddedl(Array_LK, lpsize = 5_IK, lpfill = .false._LK)")
                    Array_LK = getPaddedl(Array_LK, lpsize = 5_IK, lpfill = .false._LK)
    call disp%show("Array_LK")
    call disp%show( Array_LK )
    call disp%show("lbound(Array_LK), ubound(Array_LK)")
    call disp%show([lbound(Array_LK), ubound(Array_LK)])
    ...
    call disp%show([lbound(Array_IK), ubound(Array_IK)])
    call disp%show("Array_IK = getPaddedl(Array_IK, lpsize = 5_IK, lpfill = -0_IK)")
                    Array_IK = getPaddedl(Array_IK, lpsize = 5_IK, lpfill = -0_IK)
    call disp%show("Array_IK")
    call disp%show( Array_IK )
    call disp%show("lbound(Array_IK), ubound(Array_IK)")
    call disp%show([lbound(Array_IK), ubound(Array_IK)])
    ...
    call disp%show([lbound(Array_CK), ubound(Array_CK)])
    call disp%show("Array_CK = getPaddedl(Array_CK, lpsize = 5_IK, lpfill = (-999._CK,-999._CK))")
                    Array_CK = getPaddedl(Array_CK, lpsize = 5_IK, lpfill = (-999._CK,-999._CK))
    call disp%show("Array_CK")
    call disp%show( Array_CK )
    call disp%show("lbound(Array_CK), ubound(Array_CK)")
    call disp%show([lbound(Array_CK), ubound(Array_CK)])
    ...
    call disp%show([lbound(Array_RK), ubound(Array_RK)])
    call disp%show("Array_RK = getPaddedl(Array_RK, lpsize = 5_IK, lpfill = -0._RK)")
                    Array_RK = getPaddedl(Array_RK, lpsize = 5_IK, lpfill = -0._RK)
    call disp%show("Array_RK")
    call disp%show( Array_RK )
    call disp%show("lbound(Array_RK), ubound(Array_RK)")
    call disp%show([lbound(Array_RK), ubound(Array_RK)])
