program example
    ...
    call disp%show( len(string_SK) )
    call disp%show("string_SK = getPaddedr(string_SK, rpsize = 5_IK, rpfill = SK_'-')")
    ...
    call disp%show("len(string_SK)")
    call disp%show( len(string_SK) )
    call disp%show("string_SK = getPaddedr(string_SK, rpsize = 4_IK, rpfill = SK_' ', rmsize = 4_IK, rmfill = SK_'*')")
    ...
    call disp%show([lbound(Array_SK), ubound(Array_SK)])
    call disp%show("Array_SK = getPaddedr(Array_SK, rpsize = 5_IK, rpfill = SK_'  ')")
    ...
    call disp%show([lbound(Array_LK), ubound(Array_LK)])
    call disp%show("Array_LK = getPaddedr(Array_LK, rpsize = 5_IK, rpfill = .false._LK)")
    ...
    call disp%show([lbound(Array_IK), ubound(Array_IK)])
    call disp%show("Array_IK = getPaddedr(Array_IK, rpsize = 5_IK, rpfill = -0_IK)")
    ...
    call disp%show([lbound(Array_CK), ubound(Array_CK)])
    call disp%show("Array_CK = getPaddedr(Array_CK, rpsize = 5_IK, rpfill = (-999._CK,-999._CK))")
    ...
    call disp%show([lbound(Array_RK), ubound(Array_RK)])
    call disp%show("Array_RK = getPaddedr(Array_RK, rpsize = 5_IK, rpfill = -0._RK)")
