program example
    ...
    call disp%show( len(string_SK) )
    call disp%show("call setPadded(string_SK, lpsize = 5_IK, rpsize = 5_IK, lpfill = SK_'-', rpfill = SK_'+')")
                    call setPadded(string_SK, lpsize = 5_IK, rpsize = 5_IK, lpfill = SK_'-', rpfill = SK_'+')
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    call disp%show("len(string_SK)")
    call disp%show( len(string_SK) )
    ...
    call disp%show("len(string_SK)")
    call disp%show( len(string_SK) )
    call disp%show("call setPadded(string_SK, lpsize = 4_IK, rpsize = 4_IK, lpfill = SK_' ', rpfill = SK_' ', lmsize = 4_IK, rmsize = 8_IK, lmfill = SK_'*', rmfill = SK_'*')")
                    call setPadded(string_SK, lpsize = 4_IK, rpsize = 4_IK, lpfill = SK_' ', rpfill = SK_' ', lmsize = 4_IK, rmsize = 8_IK, lmfill = SK_'*', rmfill = SK_'*')
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    call disp%show("len(string_SK)")
    call disp%show( len(string_SK) )
    ...
    call disp%show([lbound(Array_SK), ubound(Array_SK)])
    call disp%show("call setPadded(Array_SK, lpsize = 5_IK, rpsize = 5_IK, lpfill = SK_'  ', rpfill = SK_'++')")
                    call setPadded(Array_SK, lpsize = 5_IK, rpsize = 5_IK, lpfill = SK_'  ', rpfill = SK_'++')
    call disp%show("Array_SK")
    call disp%show( Array_SK, deliml = SK_"""" )
    call disp%show("lbound(Array_SK), ubound(Array_SK)")
    call disp%show([lbound(Array_SK), ubound(Array_SK)])
    ...
    call disp%show([lbound(Array_LK), ubound(Array_LK)])
    call disp%show("call setPadded(Array_LK, lpsize = 5_IK, rpsize = 5_IK, lpfill = .false._LK, rpfill = .false._LK)")
                    call setPadded(Array_LK, lpsize = 5_IK, rpsize = 5_IK, lpfill = .false._LK, rpfill = .false._LK)
    call disp%show("Array_LK")
    call disp%show( Array_LK )
    call disp%show("lbound(Array_LK), ubound(Array_LK)")
    call disp%show([lbound(Array_LK), ubound(Array_LK)])
    ...
    call disp%show([lbound(Array_IK), ubound(Array_IK)])
    call disp%show("call setPadded(Array_IK, lpsize = 5_IK, rpsize = 5_IK, lpfill = -0_IK, rpfill = +0_IK)")
                    call setPadded(Array_IK, lpsize = 5_IK, rpsize = 5_IK, lpfill = -0_IK, rpfill = +0_IK)
    call disp%show("Array_IK")
    call disp%show( Array_IK )
    call disp%show("lbound(Array_IK), ubound(Array_IK)")
    call disp%show([lbound(Array_IK), ubound(Array_IK)])
    ...
    call disp%show([lbound(Array_CK), ubound(Array_CK)])
    call disp%show("call setPadded(Array_CK, lpsize = 5_IK, rpsize = 5_IK, lpfill = (-999._CK,-999._CK), rpfill = (+999._CK,+999._CK))")
                    call setPadded(Array_CK, lpsize = 5_IK, rpsize = 5_IK, lpfill = (-999._CK,-999._CK), rpfill = (+999._CK,+999._CK))
    call disp%show("Array_CK")
    call disp%show( Array_CK )
    call disp%show("lbound(Array_CK), ubound(Array_CK)")
    call disp%show([lbound(Array_CK), ubound(Array_CK)])
    ...
    call disp%show([lbound(Array_RK), ubound(Array_RK)])
    call disp%show("call setPadded(Array_RK, lpsize = 5_IK, rpsize = 5_IK, lpfill = -0._RK, rpfill = +0._RK)")
                    call setPadded(Array_RK, lpsize = 5_IK, rpsize = 5_IK, lpfill = -0._RK, rpfill = +0._RK)
    call disp%show("Array_RK")
    call disp%show( Array_RK )
    call disp%show("lbound(Array_RK), ubound(Array_RK)")
    call disp%show([lbound(Array_RK), ubound(Array_RK)])
