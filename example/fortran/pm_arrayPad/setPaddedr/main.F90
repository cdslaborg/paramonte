program example
    ...
    call disp%show( len(string_SK) )
    call disp%show("call setPaddedr(string_SK, rpsize = 5_IK, rpfill = SK_'-')")
                    call setPaddedr(string_SK, rpsize = 5_IK, rpfill = SK_'-')
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    call disp%show("len(string_SK)")
    call disp%show( len(string_SK) )
    ...
    call disp%show("len(string_SK)")
    call disp%show( len(string_SK) )
    call disp%show("call setPaddedr(string_SK, rpsize = 4_IK, rpfill = SK_' ', rmsize = 4_IK, rmfill = SK_'*')")
                    call setPaddedr(string_SK, rpsize = 4_IK, rpfill = SK_' ', rmsize = 4_IK, rmfill = SK_'*')
    call disp%show("string_SK")
    call disp%show( string_SK, deliml = SK_"""" )
    call disp%show("len(string_SK)")
    call disp%show( len(string_SK) )
    ...
    call disp%show([lbound(Array_SK), ubound(Array_SK)])
    call disp%show("call setPaddedr(Array_SK, rpsize = 5_IK, rpfill = SK_'  ')")
                    call setPaddedr(Array_SK, rpsize = 5_IK, rpfill = SK_'  ')
    call disp%show("Array_SK")
    call disp%show( Array_SK, deliml = SK_"""" )
    call disp%show("lbound(Array_SK), ubound(Array_SK)")
    call disp%show([lbound(Array_SK), ubound(Array_SK)])
    ...
    call disp%show([lbound(Array_LK), ubound(Array_LK)])
    call disp%show("call setPaddedr(Array_LK, rpsize = 5_IK, rpfill = .false._LK)")
                    call setPaddedr(Array_LK, rpsize = 5_IK, rpfill = .false._LK)
    call disp%show("Array_LK")
    call disp%show( Array_LK )
    call disp%show("lbound(Array_LK), ubound(Array_LK)")
    call disp%show([lbound(Array_LK), ubound(Array_LK)])
    ...
    call disp%skip()
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("! Pad a integer array.")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%")
    call disp%skip()
    ...
    call disp%show([lbound(Array_IK), ubound(Array_IK)])
    call disp%show("call setPaddedr(Array_IK, rpsize = 5_IK, rpfill = -0_IK)")
                    call setPaddedr(Array_IK, rpsize = 5_IK, rpfill = -0_IK)
    call disp%show("Array_IK")
    call disp%show( Array_IK )
    call disp%show("lbound(Array_IK), ubound(Array_IK)")
    call disp%show([lbound(Array_IK), ubound(Array_IK)])
    ...
    call disp%show([lbound(Array_CK), ubound(Array_CK)])
    call disp%show("call setPaddedr(Array_CK, rpsize = 5_IK, rpfill = (-999._CK,-999._CK))")
                    call setPaddedr(Array_CK, rpsize = 5_IK, rpfill = (-999._CK,-999._CK))
    call disp%show("Array_CK")
    call disp%show( Array_CK )
    call disp%show("lbound(Array_CK), ubound(Array_CK)")
    call disp%show([lbound(Array_CK), ubound(Array_CK)])
    ...
    call disp%show([lbound(Array_RK), ubound(Array_RK)])
    call disp%show("call setPaddedr(Array_RK, rpsize = 5_IK, rpfill = -0._RK)")
                    call setPaddedr(Array_RK, rpsize = 5_IK, rpfill = -0._RK)
    call disp%show("Array_RK")
    call disp%show( Array_RK )
    call disp%show("lbound(Array_RK), ubound(Array_RK)")
    call disp%show([lbound(Array_RK), ubound(Array_RK)])
