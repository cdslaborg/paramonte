program example
    ...
    block
        ...
        open(newunit = fileUnit, file = "xoshiro256ssw_type.IK.txt")
    ...
    block
        ...
        open(newunit = fileUnit, file = "xoshiro256ssw_type.CK.txt")
    ...
    block
        ...
        open(newunit = fileUnit, file = "xoshiro256ssw_type.RK.txt")
        write(fileUnit,"(1(g0,:,' '))") rand
        close(fileUnit)
    end block
