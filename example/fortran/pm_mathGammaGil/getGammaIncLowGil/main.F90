program example
    ...
    call disp%skip()
    call disp%show("getGammaIncLowGil(x = 1.5_RKS, kappa = 2._RKS)")
    call disp%show( getGammaIncLowGil(x = 1.5_RKS, kappa = 2._RKS) )
    call disp%skip()

    call disp%skip()
    call disp%show("getGammaIncLowGil(x = 1.5_RKD, kappa = 2._RKD)")
    call disp%show( getGammaIncLowGil(x = 1.5_RKD, kappa = 2._RKD) )
    call disp%skip()

    call disp%skip()
    call disp%show("getGammaIncLowGil(x = 1.5_RKH, kappa = 2._RKH)")
    call disp%show( getGammaIncLowGil(x = 1.5_RKH, kappa = 2._RKH) )
    call disp%skip()
    ...
    call disp%skip()
    call disp%show("getGammaIncLowGil(x = [0._RKS, 1._RKS, 10._RKS], kappa = 2._RKS)")
    call disp%show( getGammaIncLowGil(x = [0._RKS, 1._RKS, 10._RKS], kappa = 2._RKS) )
    call disp%skip()

    call disp%skip()
    call disp%show("getGammaIncLowGil(x = [0._RKD, 1._RKD, 10._RKD], kappa = 2._RKD)")
    call disp%show( getGammaIncLowGil(x = [0._RKD, 1._RKD, 10._RKD], kappa = 2._RKD) )
    call disp%skip()

    call disp%skip()
    call disp%show("getGammaIncLowGil(x = [0._RKH, 1._RKH, 10._RKH], kappa = 2._RKH)")
    call disp%show( getGammaIncLowGil(x = [0._RKH, 1._RKH, 10._RKH], kappa = 2._RKH) )
    call disp%skip()
    ...
    call disp%skip()
    call disp%show("getGammaIncLowGil(x = 1._RKS, kappa = [0.1_RKS, 1._RKS, 10._RKS])")
    call disp%show( getGammaIncLowGil(x = 1._RKS, kappa = [0.1_RKS, 1._RKS, 10._RKS]) )
    call disp%skip()

    call disp%skip()
    call disp%show("getGammaIncLowGil(x = 1._RKD, kappa = [0.1_RKD, 1._RKD, 10._RKD])")
    call disp%show( getGammaIncLowGil(x = 1._RKD, kappa = [0.1_RKD, 1._RKD, 10._RKD]) )
    call disp%skip()

    call disp%skip()
    call disp%show("getGammaIncLowGil(x = 1._RKH, kappa = [0.1_RKH, 1._RKH, 10._RKH])")
    call disp%show( getGammaIncLowGil(x = 1._RKH, kappa = [0.1_RKH, 1._RKH, 10._RKH]) )
    call disp%skip()
    ...
    block
        ...
        call disp%show("gamIncLow = getGammaIncLowGil(x = 10._RKG**exprange, kappa = 10._RKG**exprange)")
                        gamIncLow = getGammaIncLowGil(x = 10._RKG**exprange, kappa = 10._RKG**exprange)
    ...
    block
        ...
        open(newunit = fileUnit, file = "getGammaIncLowGil.RK.txt")
        do i = 1, NP
            write(fileUnit, "(*(g0,:,' '))") x_RKS(i), getGammaIncLowGil(x_RKS(i), kappa = [1.0_RKS, 2.5_RKS, 5.0_RKS])
        end do
        close(fileUnit)
