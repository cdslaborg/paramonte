program example
    ...
    call disp%show( index )
    call disp%show("stringNew_SK = getInserted(string_SK, stringInsertion_SK, index = index)")
                    stringNew_SK = getInserted(string_SK, stringInsertion_SK, index = index)
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("ArrayNew_SK = getInserted(Array_SK, ArrayInsertion_SK, index = index)")
                    ArrayNew_SK = getInserted(Array_SK, ArrayInsertion_SK, index = index)
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("ArrayNew_LK = getInserted(Array_LK, ArrayInsertion_LK, index = index)")
                    ArrayNew_LK = getInserted(Array_LK, ArrayInsertion_LK, index = index)
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("ArrayNew_IK = getInserted(Array_IK, ArrayInsertion_IK, index = index)")
                    ArrayNew_IK = getInserted(Array_IK, ArrayInsertion_IK, index = index)
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("ArrayNew_CK = getInserted(Array_CK, ArrayInsertion_CK, index = index)")
                    ArrayNew_CK = getInserted(Array_CK, ArrayInsertion_CK, index = index)
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("ArrayNew_RK = getInserted(Array_RK, ArrayInsertion_RK, index = index)")
                    ArrayNew_RK = getInserted(Array_RK, ArrayInsertion_RK, index = index)
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("stringNew_SK = getInserted(string_SK, stringInsertion_SK(1:1), index = index)")
                    stringNew_SK = getInserted(string_SK, stringInsertion_SK(1:1), index = index)
    call disp%show("stringNew_SK")
    call disp%show( stringNew_SK, deliml = SK_"""" )
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("ArrayNew_SK = getInserted(Array_SK, ArrayInsertion_SK(1), index = index)")
                    ArrayNew_SK = getInserted(Array_SK, ArrayInsertion_SK(1), index = index)
    call disp%show("ArrayNew_SK")
    call disp%show( ArrayNew_SK, deliml = SK_"""" )
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("ArrayNew_LK = getInserted(Array_LK, ArrayInsertion_LK(1), index = index)")
                    ArrayNew_LK = getInserted(Array_LK, ArrayInsertion_LK(1), index = index)
    call disp%show("ArrayNew_LK")
    call disp%show( ArrayNew_LK )
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("ArrayNew_IK = getInserted(Array_IK, ArrayInsertion_IK(1), index = index)")
                    ArrayNew_IK = getInserted(Array_IK, ArrayInsertion_IK(1), index = index)
    call disp%show("ArrayNew_IK")
    call disp%show( ArrayNew_IK )
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("ArrayNew_CK = getInserted(Array_CK, ArrayInsertion_CK(1), index = index)")
                    ArrayNew_CK = getInserted(Array_CK, ArrayInsertion_CK(1), index = index)
    call disp%show("ArrayNew_CK")
    call disp%show( ArrayNew_CK )
    ...
    call disp%show("index")
    call disp%show( index )
    call disp%show("ArrayNew_RK = getInserted(Array_RK, ArrayInsertion_RK(1), index = index)")
                    ArrayNew_RK = getInserted(Array_RK, ArrayInsertion_RK(1), index = index)
    call disp%show("ArrayNew_RK")
    call disp%show( ArrayNew_RK )
