program example
    ...
    block
        ...
        call disp%show( getMean(sample) )
        call disp%show("sample = getShifted(sample, -getMean(sample))")
                        sample = getShifted(sample, -getMean(sample))
        call disp%show("sample")
        call disp%show( sample )
        call disp%show("getMean(sample)")
        call disp%show( getMean(sample) )
    ...
    block
        ...
        call disp%show( getMean(sample, dim) )
        call disp%show("sample = getShifted(sample, dim, -getMean(sample, dim))")
                        sample = getShifted(sample, dim, -getMean(sample, dim))
        call disp%show("sample")
        call disp%show( sample )
        call disp%show("getMean(sample, dim)")
        call disp%show( getMean(sample, dim) )
    ...
    call disp%skip()
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("!Shift a 2D sample to have a zero mean along the second dimension, and transpose the result upon return.")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%skip()
    ...
    block
        ...
        call disp%show("getMean(sample, dim)")
        call disp%show( getMean(sample, dim) )
        call disp%show("sample = getShifted(sample, dim, -getMean(sample, dim), transHerm)")
                        sample = getShifted(sample, dim, -getMean(sample, dim), transHerm)
        call disp%show("sample")
        call disp%show( sample )
