program example
    ...
    block
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:5, 2:6) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, uppDia)")
                        destin(3:5, 2:6) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, uppDia)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:5, 2:6) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, dia)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:6, 3:5) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, uppDia, transSymm)")
                        destin(2:6, 3:5) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, uppDia, transSymm)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:6, 3:5) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, dia, transSymm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:6, 3:5) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, uppDia, transHerm)")
                        destin(2:6, 3:5) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, uppDia, transHerm)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:6, 3:5) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, dia, transHerm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:5, 2:6) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, lowDia)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:6, 3:5) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, lowDia, transSymm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:6, 3:5) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, lowDia, transHerm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:5, 2:6) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, uppLow)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:6, 3:5) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, uppLow, transSymm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:6, 3:5) = getMatCopy(rdpack, source(2:4, 3:7), rdpack, uppLow, transHerm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 2:4) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, uppDia)")
                        destin(3:7, 2:4) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, uppDia)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 2:4) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, dia)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:4, 3:7) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, uppDia, transSymm)")
                        destin(2:4, 3:7) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, uppDia, transSymm)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:4, 3:7) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, dia, transSymm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:4, 3:7) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, uppDia, transHerm)")
                        destin(2:4, 3:7) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, uppDia, transHerm)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:4, 3:7) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, dia, transHerm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 2:4) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, lowDia)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:4, 3:7) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, lowDia, transSymm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:4, 3:7) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, lowDia, transHerm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 2:4) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, uppLow)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:4, 3:7) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, uppLow, transSymm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:4, 3:7) = getMatCopy(rdpack, source(2:6, 3:5), rdpack, uppLow, transHerm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppDia)")
                        destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppDia)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, dia)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppDia, transSymm)")
                        destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppDia, transSymm)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, dia, transSymm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppDia, transHerm)")
                        destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppDia, transHerm)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, dia, transHerm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, lowDia)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, lowDia, transSymm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, lowDia, transHerm)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppLow, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppLow, transSymm, doff)")
                        destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppLow, transSymm, doff)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, dia, transSymm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppLow, transHerm, doff)")
                        destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, uppLow, transHerm, doff)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:7) = getMatCopy(rdpack, source(1:5, 1:5), rdpack, dia, transHerm, doff)")
        ...
        call disp%show("doff = -3")
                        doff = -3
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, uppDia, doff)")
                        destin(3:9, 3:7) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, uppDia, doff)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, dia, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, uppDia, transSymm, doff)")
                        destin(3:7, 3:9) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, uppDia, transSymm, doff)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, dia, transSymm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, uppDia, transHerm, doff)")
                        destin(3:7, 3:9) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, uppDia, transHerm, doff)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, dia, transHerm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, lowDia, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, lowDia, transSymm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, lowDia, transHerm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, uppLow, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, uppLow, transSymm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:7, 1:5), rdpack, uppLow, transHerm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, uppDia, doff)")
                        destin(3:7, 3:9) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, uppDia, doff)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, dia, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, uppDia, transSymm, doff)")
                        destin(3:9, 3:7) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, uppDia, transSymm, doff)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, dia, transSymm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, uppDia, transHerm, doff)")
                        destin(3:9, 3:7) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, uppDia, transHerm, doff)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, dia, transHerm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, lowDia, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, lowDia, transSymm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, lowDia, transHerm, doff)")
        ...
        call disp%show("doff = -3")
                        doff = -3
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, uppLow, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, uppLow, transSymm, doff)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(1:5, 1:7), rdpack, uppLow, transHerm, doff)")
    ...
    block
        ...
        call disp%show("destin = NONE")
                        destin = NONE
        call disp%show("destin(2:3, 2:4) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, uppDia, doff)")
                        destin(2:3, 2:4) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, uppDia, doff)
        call disp%show("destin")
        call disp%show( destin , format = cform )
        call disp%show("destin = NONE")
                        destin = NONE
        call disp%show("destin(2:3, 2:4) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, dia, doff)")
        ...
        call disp%show("destin = NONE")
                        destin = NONE
        call disp%show("destin(2:4, 2:3) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, uppDia, transSymm, doff)")
                        destin(2:4, 2:3) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, uppDia, transSymm, doff)
        call disp%show("destin")
        call disp%show( destin , format = cform )
        call disp%show("destin = NONE")
                        destin = NONE
        call disp%show("destin(2:4, 2:3) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, dia, transSymm, doff)")
        ...
        call disp%show("destin = NONE")
                        destin = NONE
        call disp%show("destin(2:4, 2:3) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, uppDia, transHerm, doff)")
                        destin(2:4, 2:3) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, uppDia, transHerm, doff)
        call disp%show("destin")
        call disp%show( destin , format = cform )
        call disp%show("destin = NONE")
                        destin = NONE
        call disp%show("destin(2:4, 2:3) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, dia, transHerm, doff)")
        ...
        call disp%show("doff = +1")
                        doff = +1
        call disp%show("destin(2:3, 2:4) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, lowDia, doff)")
        ...
        call disp%show("destin = NONE")
                        destin = NONE
        call disp%show("destin(2:4, 2:3) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, lowDia, transSymm, doff)")
        ...
        call disp%show("destin = NONE")
                        destin = NONE
        call disp%show("destin(2:4, 2:3) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, lowDia, transHerm, doff)")
        ...
        call disp%show("doff = -1")
                        doff = -1
        call disp%show("destin(2:3, 2:4) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, uppLow, doff)")
        ...
        call disp%show("destin = NONE")
                        destin = NONE
        call disp%show("destin(2:4, 2:3) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, uppLow, transSymm, doff)")
        ...
        call disp%show("destin = NONE")
                        destin = NONE
        call disp%show("destin(2:4, 2:3) = getMatCopy(rdpack, source(1:2, 1:3), rdpack, uppLow, transHerm, doff)")
    ...
    block
        ...
        character(2,SKC), parameter :: EMPTY = SKC_"  "
        character(2,SKC) :: source((ndim + 1) * ndim / 2), destin(ndim, ndim)
        character(2,SKC), allocatable :: desnew(:)
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:7,3:7) = getMatCopy(rdpack, source(2:6), lfpack, dia)")
                        destin(3:7,3:7) = getMatCopy(rdpack, source(2:6), lfpack, dia)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("desnew = getMatCopy(lfpack, destin(3:9,3:7), rdpack, dia)")
        ...
        call disp%show("doff = -3")
                        doff = -3
        call disp%show("destin(3:9,3:7) = getMatCopy(rdpack, source(2:5), lfpack, dia, doff, shape = [7, 5])")
                        destin(3:9,3:7) = getMatCopy(rdpack, source(2:5), lfpack, dia, doff, shape = [7, 5])
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("desnew = getMatCopy(lfpack, destin(3:9,3:7), rdpack, dia, doff)")
        ...
        call disp%show("doff = +3;")
                        doff = +3;
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source(2:5), lfpack, dia, doff, shape = [5, 7])")
                        destin(3:7, 3:9) = getMatCopy(rdpack, source(2:5), lfpack, dia, doff, shape = [5, 7])
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("desnew = getMatCopy(lfpack, destin(3:7, 3:9), rdpack, dia, doff)")
        ...
        call disp%show("doff = +3;")
                        doff = +3;
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source(2:3), lfpack, dia, doff, shape = [7, 5])")
    ...
    block
        ...
        call disp%show("doff = -3")
                        doff = -3
        call disp%show("destin(3:9,3:7) = getMatCopy(rdpack, source, lfpack, uppDia, doff, shape = [7, 5])")
                        destin(3:9,3:7) = getMatCopy(rdpack, source, lfpack, uppDia, doff, shape = [7, 5])
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("desnew = getMatCopy(lfpack, destin(3:9,3:7), rdpack, uppDia, doff)")
        ...
        call disp%show("doff = -3")
                        doff = -3
        call disp%show("destin(3:9,3:7) = getMatCopy(rdpack, source, lfpack, uppDia, transSymm, doff, shape = [7, 5])")
                        destin(3:9,3:7) = getMatCopy(rdpack, source, lfpack, uppDia, transSymm, doff, shape = [7, 5])
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("desnew = getMatCopy(lfpack, destin(3:9,3:7), rdpack, lowDia, transSymm, -doff)")
        ...
        call disp%show("doff = +3;")
                        doff = +3;
        call disp%show("destin(3:7, 3:9) = getMatCopy(rdpack, source, lfpack, lowDia, doff, shape = [5, 7])")
                        destin(3:7, 3:9) = getMatCopy(rdpack, source, lfpack, lowDia, doff, shape = [5, 7])
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source, lfpack, lowDia, transSymm, doff, shape = [7, 5])")
        ...
        call disp%show("doff = +3;")
                        doff = +3;
        call disp%show("destin(3:9, 3:7) = getMatCopy(rdpack, source, lfpack, lowDia, transHerm, doff, shape = [7, 5])")
                        destin(3:9, 3:7) = getMatCopy(rdpack, source, lfpack, lowDia, transHerm, doff, shape = [7, 5])
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("desnew = getMatCopy(lfpack, destin(3:9,3:7), rdpack, lowDia, transHerm, doff)")
    ...
    block
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(4:8, 3:5) = getMatCopy(rfpack, source(2:6, 3:7), rdpack, uppDia)")
                        destin(4:8, 3:5) = getMatCopy(rfpack, source(2:6, 3:7), rdpack, uppDia)
        call disp%show("destin")
        call disp%show( destin , deliml = SK_"""" )
        call disp%show("desnew = transpose(getMatCopy(rfpack, source(2:6, 3:7), rdpack, uppDia)) ! transpose")
                        desnew = transpose(getMatCopy(rfpack, source(2:6, 3:7), rdpack, uppDia)) ! transpose
        call disp%show("desnew")
        call disp%show( desnew , deliml = SK_"""" )
        call disp%show("desnew = getMatCopy(rdpack, destin(4:8, 3:5), rfpack, uppDia)")
        ...
        call disp%show("destin = EMPTY")
                        destin = EMPTY
        call disp%show("destin(2:6,3:5) = getMatCopy(rfpack, source(2:6, 3:7), rdpack, lowDia)")
                        destin(2:6,3:5) = getMatCopy(rfpack, source(2:6, 3:7), rdpack, lowDia)
        call disp%show("destin(2:6,3:5)")
        call disp%show( destin(2:6,3:5) , deliml = SK_"""" )
        call disp%show("desnew = getMatCopy(rdpack, destin(4:8, 3:5), rfpack, lowDia)")
