program example
    ...
    call disp%show("path = SK_''")
                    path = SK_''
    call disp%show("getPathHostNameIndex(path, SK_'/')")
    call disp%show( getPathHostNameIndex(path, SK_'/') )
    call disp%show("path(1:getPathHostNameIndex(path, SK_'/'))")
    call disp%show( path(1:getPathHostNameIndex(path, SK_'/')) , deliml = """" )
    call disp%skip()
    ...
    call disp%skip()
    call disp%show("path = SK_'\\wsl$\Ubuntu-20.04\home\'")
