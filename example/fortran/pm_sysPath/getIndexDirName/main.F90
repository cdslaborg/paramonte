program example
    ...
    use pm_sysPath, only: getIndexDirName
    ...
    call disp%show("path = SK_''")
                    path = SK_''
    call disp%show("getIndexDirName(path, SK_'/')")
    call disp%show( getIndexDirName(path, SK_'/') )
    call disp%show("path(1:getIndexDirName(path, SK_'/'))")
    call disp%show( path(1:getIndexDirName(path, SK_'/')) , deliml = """" )
    call disp%skip()
