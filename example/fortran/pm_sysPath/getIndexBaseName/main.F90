program example
    ...
    use pm_sysPath, only: getIndexBaseName
    ...
    call disp%show("path = SK_''")
                    path = SK_''
    call disp%show("getIndexBaseName(path, SK_'/')")
    call disp%show( getIndexBaseName(path, SK_'/') )
    call disp%show("path(getIndexBaseName(path, SK_'/'):)")
    call disp%show( path(getIndexBaseName(path, SK_'/'):) , deliml = """" )
    call disp%skip()
