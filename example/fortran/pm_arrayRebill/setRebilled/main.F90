...
block; \
    ...
    call disp%show('ub'); \
    call disp%show( UB ); \
    call disp%show('call setRebilled(array, fill, lb, ub)'); \
...
block; \
    ...
    call disp%show('lbc'); \
    call disp%show( LBC ); \
    call disp%show('call setRebilled(array, fill, lb, ub, lbc)'); \
...
#define REBILL_SHIFT_SUBSET_ARRAY \
block; \
    DECLARE; \
    CONSTRUCT; \
    call disp%show('array'); \
    ...
    call disp%show( UBCOLD ); \
    call disp%show('call setRebilled(array, fill, lb, ub, lbc, lbcold, ubcold)'); \
...
REBILL_ARRAY
    ...
    call disp%skip()
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("! Expand `character` with partially-overlapping bounds.")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%skip()
...
REBILL_ARRAY
    ...
    call disp%skip()
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("! Expand `character` with entirely new non-overlapping bounds.")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%skip()
...
REBILL_SHIFT_ARRAY
    ...
    call disp%skip()
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("! Expand and shift `character` with partially-overlapping bounds.")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%skip()

#define LB [-1_IK, -1_IK]
#define UB [+2_IK, +4_IK]
#define LBC [0_IK, 0_IK]
#define FILL SKC_"--"
#define DECLARE character(2,SKC), allocatable :: array(:,:)
#define CONSTRUCT allocate(array(2:3,3:5)); array(:,:) = reshape(["AA", "BB", "CC", "DD", "EE", "FF"], shape = shape(array), order = [2, 1])
REBILL_SHIFT_ARRAY
    ...
    call disp%skip()
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%show("! Expand and shift `character` with entirely new non-overlapping bounds.")
    call disp%show("!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    call disp%skip()

#define LB [-1_IK, -1_IK]
#define UB [+1_IK, +2_IK]
#define LBC [-1_IK, 1_IK]
#define FILL SKC_"--"
#define DECLARE character(2,SKC), allocatable :: array(:,:)
#define CONSTRUCT allocate(array(2:3,3:5)); array(:,:) = reshape(["AA", "BB", "CC", "DD", "EE", "FF"], shape = shape(array), order = [2, 1])
REBILL_SHIFT_ARRAY
