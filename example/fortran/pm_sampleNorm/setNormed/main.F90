program example
    ...
    block
        ...
        call disp%show( getVar(sample) )
        call disp%show("call setNormed(sample, -getMean(sample), 1._TKC / sqrt(getVar(sample)))")
                        call setNormed(sample, -getMean(sample), 1._TKC / sqrt(getVar(sample)))
        call disp%show("sample")
        call disp%show( sample )
        call disp%show("getMean(sample)")
        call disp%show( getMean(sample) )
    ...
    block
        ...
        call disp%show( getVar(sample, dim) )
        call disp%show("call setNormed(sample, dim, -getMean(sample, dim), 1._TKC / sqrt(getVar(sample, dim)))")
                        call setNormed(sample, dim, -getMean(sample, dim), 1._TKC / sqrt(getVar(sample, dim)))
        call disp%show("sample")
        call disp%show( sample )
        call disp%show("getMean(sample, dim)")
        call disp%show( getMean(sample, dim) )
