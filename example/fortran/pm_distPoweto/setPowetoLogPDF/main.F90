program example
    ...
    call disp%skip()
    call disp%show("call setPowetoLogPDF(logPDF(1), logx = 3., alpha = -2., logPDFNF = getPowetoLogPDFNF(alpha = -2., logMinX = -2.)) ! Poweto distribution.")
    ...
    call disp%skip()
    call disp%show("call setPowetoLogPDF(logPDF(1:3), logx = [3., 4., 5.], alpha = -[+2., +3., +4.], logPDFNF = getPowetoLogPDFNF(alpha = -[+2., +3., +4.], logMinX = -2.)) ! Poweto distribution.")
    ...
    call disp%skip()
    call disp%show("call setPowetoLogPDF(logPDF(1), logx = 3., alpha = -2., logPDFNF = getPowetoLogPDFNF(alpha = -2., logMinX = -2., logMaxX = 5.)) ! Truncated Poweto distribution.")
    ...
    call disp%skip()
    call disp%show("call setPowetoLogPDF(logPDF(1:3), logx = [3., 4., 5.], alpha = -[+2., +3., +4.], logPDFNF = getPowetoLogPDFNF(alpha = -[+2., +3., +4.], logMinX = -2., logMaxX = 5.)) ! Truncated Poweto distribution.")
    ...
    call disp%skip()
    call disp%show("call setPowetoLogPDF(logPDF(1), logx = 3., alpha = +2., logPDFNF = getPowetoLogPDFNF(alpha = +2., logMaxX = 5.)) ! Poweto distribution.")
    ...
    call disp%skip()
    call disp%show("call setPowetoLogPDF(logPDF(1:3), logx = [3., 4., 5.], alpha = [+2., +3., +4.], logPDFNF = getPowetoLogPDFNF(alpha = [+2., +3., +4.], logMaxX = 5.)) ! Poweto distribution.")
    ...
    block
        ...
        do i = 1, size(logx, 1, IK)
            if (logMinX <= logx(i) .and. logx(i) <= logMaxX) then
                call setPowetoLogPDF(logPDF, logx(i), alpha, getPowetoLogPDFNF(alpha, logMinX, logMaxX))
            else
                logPDF = -huge(0.)
            end if
