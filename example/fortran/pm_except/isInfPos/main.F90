program example
    ...
    call disp%show( X_RK32(1) )
    call disp%show("isInfPos(X_RK32(1))")
    call disp%show( isInfPos(X_RK32(1)) )
    call disp%skip
    ...
    call disp%show( X_RK32 )
    call disp%show("isInfPos(X_RK32)")
    call disp%show( isInfPos(X_RK32) )
    call disp%skip
    ...
    call disp%show( X_RK64(1) )
    call disp%show("isInfPos(X_RK64(1))")
    call disp%show( isInfPos(X_RK64(1)) )
    call disp%skip
    ...
    call disp%show( X_RK64 )
    call disp%show("isInfPos(X_RK64)")
    call disp%show( isInfPos(X_RK64) )
    call disp%skip
    ...
    call disp%show( X_RK128(1) )
    call disp%show("isInfPos(X_RK128(1))")
    call disp%show( isInfPos(X_RK128(1)) )
    call disp%skip
    ...
    call disp%show( X_RK128 )
    call disp%show("isInfPos(X_RK128)")
    call disp%show( isInfPos(X_RK128) )
    call disp%skip
    ...
    call disp%show( X_CK32(1) )
    call disp%show("isInfPos(X_CK32(1))")
    call disp%show( isInfPos(X_CK32(1)) )
    call disp%skip
    ...
    call disp%show( X_CK32 )
    call disp%show("isInfPos(X_CK32)")
    call disp%show( isInfPos(X_CK32) )
    call disp%skip
    ...
    call disp%show( X_CK64(1) )
    call disp%show("isInfPos(X_CK64(1))")
    call disp%show( isInfPos(X_CK64(1)) )
    call disp%skip
    ...
    call disp%show( X_CK64 )
    call disp%show("isInfPos(X_CK64)")
    call disp%show( isInfPos(X_CK64) )
    call disp%skip
    ...
    call disp%show( X_CK128(1) )
    call disp%show("isInfPos(X_CK128(1))")
    call disp%show( isInfPos(X_CK128(1)) )
    call disp%skip
    ...
    call disp%show( X_CK128 )
    call disp%show("isInfPos(X_CK128)")
    call disp%show( isInfPos(X_CK128) )
    call disp%skip
