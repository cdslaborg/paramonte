program example
    ...
    call disp%skip
    call disp%show("isAddOutflow(1, 1)")
    call disp%show( isAddOutflow(1, 1) )
    call disp%skip
    ...
    call disp%skip
    call disp%show("isAddOutflow([huge(1), -huge(1)], [huge(1), -huge(1)])")
    call disp%show( isAddOutflow([huge(1), -huge(1)], [huge(1), -huge(1)]) )
    call disp%skip
    ...
    call disp%skip
    call disp%show("isAddOutflow((1., -1), (1., -1))")
    call disp%show( isAddOutflow((1., -1), (1., -1)) )
    call disp%skip

    call disp%skip
    call disp%show("isAddOutflow(cmplx(1., huge(1.)), [(0., 0.), cmplx(huge(0.), 1.), cmplx(-huge(1), -huge(1))])")
    call disp%show( isAddOutflow(cmplx(1., huge(1.)), [(0., 0.), cmplx(huge(0.), 1.), cmplx(-huge(1), -huge(1))]) )
    call disp%skip
    ...
    call disp%skip
    call disp%show("isAddOutflow([huge(1.), huge(1.), huge(1.), -huge(1.)], [-1., 1., huge(1.), -huge(1.)])")
    call disp%show( isAddOutflow([huge(1.), huge(1.), huge(1.), -huge(1.)], [-1., 1., huge(1.), -huge(1.)]) )
    call disp%skip
