program example
    ...
    call disp%skip
    call disp%show("call setNAN(X_RK32(1))")
                    call setNAN(X_RK32(1))
    call disp%show("X_RK32(1)")
    call disp%show( X_RK32(1) )
    call disp%skip

    call disp%skip
    call disp%show("call setNAN(X_RK32)")
                    call setNAN(X_RK32)
    ...
    call disp%skip
    call disp%show("call setNAN(X_RK64(1))")
                    call setNAN(X_RK64(1))
    call disp%show("X_RK64(1)")
    call disp%show( X_RK64(1) )
    call disp%skip

    call disp%skip
    call disp%show("call setNAN(X_RK64)")
                    call setNAN(X_RK64)
    ...
    call disp%skip
    call disp%show("call setNAN(X_RK128(1))")
                    call setNAN(X_RK128(1))
    call disp%show("X_RK128(1)")
    call disp%show( X_RK128(1) )
    call disp%skip

    call disp%skip
    call disp%show("call setNAN(X_RK128)")
                    call setNAN(X_RK128)
    ...
    call disp%skip
    call disp%show("call setNAN(X_CK32(1))")
                    call setNAN(X_CK32(1))
    call disp%show("X_CK32(1)")
    call disp%show( X_CK32(1) )
    call disp%skip

    call disp%skip
    call disp%show("call setNAN(X_CK32)")
                    call setNAN(X_CK32)
    ...
    call disp%skip
    call disp%show("call setNAN(X_CK64(1))")
                    call setNAN(X_CK64(1))
    call disp%show("X_CK64(1)")
    call disp%show( X_CK64(1) )
    call disp%skip

    call disp%skip
    call disp%show("call setNAN(X_CK64)")
                    call setNAN(X_CK64)
    ...
    call disp%skip
    call disp%show("call setNAN(X_CK128(1))")
                    call setNAN(X_CK128(1))
    call disp%show("X_CK128(1)")
    call disp%show( X_CK128(1) )
    call disp%skip

    call disp%skip
    call disp%show("call setNAN(X_CK128)")
                    call setNAN(X_CK128)
