program example
    ...
    block
        ...
        call disp%show("if (0 /= getErrTableWrite(SK_'setUnifEllsRandMean.txt', rand, trans)) error stop 'Failed to write the random vectors file.'")
                        if (0 /= getErrTableWrite(SK_'setUnifEllsRandMean.txt', rand, trans)) error stop 'Failed to write the random vectors file.'
        call disp%skip()
        ...
        call disp%show("if (0 /= getErrTableWrite(SK_'setUnifEllsRandMeanChol.txt', rand, trans)) error stop 'Failed to write the random vectors file.'")
                        if (0 /= getErrTableWrite(SK_'setUnifEllsRandMeanChol.txt', rand, trans)) error stop 'Failed to write the random vectors file.'
        call disp%skip()
