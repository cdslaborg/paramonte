...
///
/// The ParaMonte C++ library ships with ample example usage that are available in the `example/cpp` folder in the [root directory of the project repository](https://github.com/cdslaborg/paramonte).<br>
