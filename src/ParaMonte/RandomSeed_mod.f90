...
!***********************************************************************************************************************************  
    ...
    subroutine setRandomSeed(RandomSeed,inputSeed)
...
#endif
        use Constants_mod, only: IK, HUGE_IK
        ...
        ! This needs to be taken care of, in the future. This problem showed itself when StartPoint in ParaDRAM were to be set randomly. 
        ! This is where the first instance of random number usage occurs in ParaDRAM.
