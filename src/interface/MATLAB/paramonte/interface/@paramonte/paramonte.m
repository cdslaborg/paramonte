...
classdef paramonte %< dynamicprops
    ...
    methods (Access=public, Hidden)
        ...
        function mpiBinPath = findMPI(self)
            ...
            if self.platform.isWin32
                ...
                for thisPath = pathList
                    ...
                    if contains(pathLower,"mpiintel64bin")
                        mpivarsFilePath = string(fullfile( thisPath, "mpivars.bat" ));
            ...
            elseif self.platform.isMacOS
                ...
                if ~isempty(mpiexecPath) && ~isempty(gfortranPath)
                    [thisPath,~,~] = fileparts(mpiexecPath); thisPath = string(thisPath);
                ...
                if self.platform.isLinux
                    ...
                    if defaultIntelLinuxMpiPath.mpiRootDirNotFound
                        ...
                        self.Err.msg    = "Failed to find the MPI runtime environment setup file on your system." + newline ...
                                        ...
                                        + "    " + defaultIntelLinuxMpiPath.mpiRootDir(1) + newline + newline ...
                                        + "or," + newline + newline ...
                                        ... + "    " + string(defaultIntelLinuxMpiPath.strrep(mpiRootDir(2),'\','\\')) + newline + newline ...
                                        + "    " + defaultIntelLinuxMpiPath.mpiRootDir(2) + newline + newline ...
                                        ...
                                        + "    " + defaultIntelLinuxMpiPath.mpivarsFilePathDefault(1) + newline + newline ...
                                        + "or," + newline + newline ...
                                        ... + "    " + string(strrep(defaultIntelLinuxMpiPath.mpivarsFilePathDefault(2),'\','\\')) + newline + newline ...
                                        + "    " + defaultIntelLinuxMpiPath.mpivarsFilePathDefault(2) + newline + newline ...
                                        ...
                                        + "    source " + defaultIntelLinuxMpiPath.mpivarsFilePathDefault(1) + newline + newline ...
                                        + "or," + newline + newline ...
                                        ... + "    source " + string(strrep(defaultIntelLinuxMpiPath.mpivarsFilePathDefault(2),'\','\\')) + newline + newline ...
                                        + "    source " + defaultIntelLinuxMpiPath.mpivarsFilePathDefault(2) + newline + newline ...
        ...
        function mpiBinDir = setupIntelLinuxMpiPath(self,defaultIntelLinuxMpiPath)
            mpiBinDir = string(fullfile(defaultIntelLinuxMpiPath.mpiRootDir(end), "bin"));
            mpiLibDir = string(fullfile(defaultIntelLinuxMpiPath.mpiRootDir(end), "lib"));
