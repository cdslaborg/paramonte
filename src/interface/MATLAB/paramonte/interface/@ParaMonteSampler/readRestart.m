...
function [varargout] = readRestart(self,varargin)
    ...
    if ~self.mpiEnabled
        ...
        self.Err.msg    = self.Err.msg + newline ...
                        ...
                        + "    " + outputListFullName + "{1}.plot.covmat.plot()         %% to make proposal covariance evolution plots." + newline ...
                        + "    " + outputListFullName + "{1}.plot.covmat3.plot()        %% to make proposal covariance evolution 3D plots." + newline ...
                        + "    " + outputListFullName + "{1}.plot.cormat.plot()         %% to make proposal correlation evolution plots." + newline ...
