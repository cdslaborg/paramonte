...
%                    StateNew = mvnrnd(StateOld, comv_chol(:,:,counterDRS+1));
    ...
    %*******************************************************************************************************************************
        ...
        function writeRestartFile()
            ...
            fprintf(mc_restartFileUnit, mc_restartFileFormat    , "sampleSizeOld"                               ...
                                                                , mv_sampleSizeOld_save                         ...
                                                                , "logSqrtDetOld"                               ...
                                                                , mv_logSqrtDetOld_save                         ...
                                                                ...
                                                                , "CholDiagLower(1:ndim, 1:ndim+1, 1)"          ...
                                                                , comv_CholDiagLower(1:mc_ndim, 1:mc_ndim+1, 1) ...
                                                                ) ;
