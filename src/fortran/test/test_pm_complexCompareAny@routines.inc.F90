...
!>  \brief
!>  This include file contains the implementations of the tests of procedures of [test_pm_complexCompareAny](@ref test_pm_complexCompareAny).
!>
!>  \author
...
#if isanyless_CK_ENABLED
#define COMPARES_WITH_DEF <
#define COMPARES_WITH <
        character(*, SK), parameter :: PROCEDURE_NAME = "isanyless()"
#elif isanyleq_CK_ENABLED
#define COMPARES_WITH_DEF <=
#define COMPARES_WITH <=
        character(*, SK), parameter :: PROCEDURE_NAME = "isanyleq()"
#elif isanyneq_CK_ENABLED
#define COMPARES_WITH_DEF /=
#define COMPARES_WITH .anyneq.
        character(*, SK), parameter :: PROCEDURE_NAME = "isanyneq()"
#elif isanyeq_CK_ENABLED
#define COMPARES_WITH_DEF ==
#define COMPARES_WITH .anyeq.
        character(*, SK), parameter :: PROCEDURE_NAME = "isanyeq()"
#elif isanymeq_CK_ENABLED
#define COMPARES_WITH_DEF >=
#define COMPARES_WITH >=
        character(*, SK), parameter :: PROCEDURE_NAME = "isanymeq()"
#elif isanymore_CK_ENABLED
#define COMPARES_WITH_DEF >
#define COMPARES_WITH >
        character(*, SK), parameter :: PROCEDURE_NAME = "isanymore()"
#else
#error "Unrecognized interface."
        ...
        do j = 1, NP
            do i = 1, NP
                ...
                result_def(i,j) = mat1(i,j)%re COMPARES_WITH_DEF mat2(i,j)%re .or. mat1(i,j)%im COMPARES_WITH_DEF mat2(i,j)%im
        ...
        do j = 1, NP
            ...
            result_def(:,j) = mat1(:,j)%re COMPARES_WITH_DEF mat2(:,j)%re .or. mat1(:,j)%im COMPARES_WITH_DEF mat2(:,j)%im
        ...
        result_def(:,:) = mat1(:,:)%re COMPARES_WITH_DEF mat2(:,:)%re .or. mat1(:,:)%im COMPARES_WITH_DEF mat2(:,:)%im
