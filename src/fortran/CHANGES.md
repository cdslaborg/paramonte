# ParaMonte Fortran release notes
...
+   This is a major interface-breaking release:  
    +   The ParaMonte Fortran library has now grown to nearly one-million lines of code.  
    +   Thousands of new functionalities, tens of thousands examples, and millions of new unit tests have been added.  
    +   The names of the basic specifications of the ParaDRAM library have been modified to better reflect the organization of the library. 
    ...
    +   There are new functionalities that are going to integrated with this new release 
        details of which can be found in the [ParaMonte Fortran library documentation](https://www.cdslab.org/paramonte/fortran/2/index.html)
