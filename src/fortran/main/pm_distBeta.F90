...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    !>  \brief
    !>  This is the derived type for signifying distributions that are of type Beta
    !>  as defined in the description of [pm_distBeta](@ref pm_distBeta).
    !>
    !>  \details
    !>  See the documentation of [pm_distBeta](@ref pm_distBeta) for the definition of the Beta distribution.
    !>
    !>  \interface{distBeta_type}
    !>  \code{.F90}
    !>
    !>      use pm_distBeta, only: distBeta_type
    !>      type(distBeta_type) :: distBeta
    !>
    !>      distBeta = distBeta_type()
    !>
    !>  \endcode
    !>
    !>  \devnote
