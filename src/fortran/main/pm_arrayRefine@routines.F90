...
!>  \brief
!>  This file contains procedure implementations of [pm_arrayRefine](@ref pm_arrayRefine).
!>
!>  \final
!>
!>  \author
...
submodule (pm_arrayRefine) routines ! LCOV_EXCL_LINE
...
#undef getRefined_ENABLED

!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

#define setRefined_ENABLED 1
