...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    PURE module function getDE_D2_XX_RK5(point, method) result(distance)
        ...
        use pm_kind, only: RKC => RK5
        real(RKC)           , intent(in)    , contiguous    :: point(:,:)
        real(RKC)                                           :: distance(size(point, 2, IK))
        class(*)            , intent(in)    , optional      :: method
    end function
#endif
...
#endif
        use pm_kind, only: RKC => RK5
        real(RKC)           , intent(in)    , contiguous    :: ref(:)
        real(RKC)           , intent(in)    , contiguous    :: point(:)
        real(RKC)                                           :: distance
        class(*)            , intent(in)    , optional      :: method
    end function
    ...
    PURE module function getDE_D1_D2_RK5(point, ref, method) result(distance)
        ...
        real(RKC)           , intent(in)    , contiguous    :: ref(:,:)
        real(RKC)           , intent(in)    , contiguous    :: point(:)
        real(RKC)                                           :: distance(size(ref, 2, IK))
        class(*)            , intent(in)    , optional      :: method
    end function
#endif
    ...
    PURE module function getDE_D2_D2_RK5(point, ref, method) result(distance)
        ...
        real(RKC)           , intent(in)    , contiguous    :: ref(:,:)
        real(RKC)           , intent(in)    , contiguous    :: point(:,:)
        real(RKC)                                           :: distance(size(ref, 2, IK), size(point, 2, IK))
        class(*)            , intent(in)    , optional      :: method
    end function
#endif
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    PURE module subroutine setDE_MED_D2_XX_RK5(distance, point, method)
        ...
        use pm_kind, only: RKC => RK5
        real(RKC)           , intent(in)    , contiguous    :: point(:,:)
        real(RKC)           , intent(out)   , contiguous    :: distance(:)
        type(euclid_type)   , intent(in)                    :: method
    end subroutine
#endif
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    PURE module function getDME_RDP_FUL_RK5(point, method) result(distance)
        ...
        use pm_kind, only: RKC => RK5
        real(RKC)           , intent(in)    , contiguous    :: point(:,:)
        real(RKC)                                           :: distance(size(point, 2, IK), size(point, 2, IK))
        class(*)            , intent(in)    , optional      :: method
    end function
#endif
    ...
    PURE module function getDME_RDP_ULX_RK5(pack, subset, point, method) result(distance)
        ...
        use pm_kind, only: RKC => RK5
        real(RKC)           , intent(in)    , contiguous    :: point(:,:)
        real(RKC)                                           :: distance(size(point, 2, IK) - 1, size(point, 2, IK))
        class(*)            , intent(in)    , optional      :: method
