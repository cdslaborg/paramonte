...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    module subroutine setChangeUnifRNGF_SK5(rng, change, start, stop, step, unique)
        ...
        character(1,SKG)            , intent(in)                    :: start, stop
        character(*,SKG)            , intent(out)                   :: change
    end subroutine
#endif
    ...
    module subroutine setChangeUnifRNGF_IK5(rng, change, start, stop, step, unique)
        ...
        type(rngf_type)             , intent(in)                    :: rng
        integer(IKG)                , intent(in)                    :: start, stop, step
        integer(IKG)                , intent(out)   , contiguous    :: change(:)
    end subroutine
#endif
    ...
    module subroutine setChangeUnifRNGF_RK5(rng, change, start, stop, step, unique)
        ...
        type(rngf_type)             , intent(in)                    :: rng
        real(RKG)                   , intent(in)                    :: start, stop, step
        real(RKG)                   , intent(out)   , contiguous    :: change(:)
    end subroutine
#endif
