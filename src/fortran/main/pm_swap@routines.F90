...
!>  \brief
!>  This file contains procedure implementations of [pm_swap](@ref pm_swap).
!>
!>  \final
!>
!>  \author
...
submodule (pm_swap) routines ! LCOV_EXCL_LINE
