...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        integer(IKC) :: i
        CHECK_ASSERTION(__LINE__, 0_IKC <= n, SK_"@getFactorial(): The condition `0 <= n` must hold. n = "//getStr(n))
        factorial = 1_IKC
        do i = 2_IKC, n
            factorial = i * factorial
        end do
#elif   getLogFactorial_ENABLED && RK_ENABLED
        CHECK_ASSERTION(__LINE__, 0._RKC <= x, SK_"@getLogFactorial(): The input `0. <= x` must hold. x = "//getStr(x))
        ...
        logFactorial = log_gamma(x + 1._RKC)
#else
