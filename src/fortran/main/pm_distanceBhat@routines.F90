...
!>  \brief
!>  This file contains procedure implementations of [pm_distanceBhat](@ref pm_distanceBhat).
!>
!>  \finmain
!>
!>  \author
...
submodule (pm_distanceBhat) routines ! LCOV_EXCL_LINE
