...
%>  the MATLAB Reinforcement Learning Toolbox.
%>
%>  \details
...
%>
%>  \interface{reinflearning}
%>  \code{.m}
%>
%>      hasit = pm.matlab.has.reinflearning();
%>
%>  \endcode
%>
%>  \example{reinflearning}
%>  \include{lineno} example/matlab/has/main.m
%>  \output{reinflearning}
...
function hasit = reinflearning()
    hasit = license('test', 'Reinforcement_Learn_Toolbox');
end