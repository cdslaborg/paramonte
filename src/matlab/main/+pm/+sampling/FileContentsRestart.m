...
classdef FileContentsRestart < pm.io.FileContents
    ...
    properties(Access = public)
        %>
        %>   \param[in] count           :   The scalar MATLAB integer containing the number of
        %>                                  restart entries in the specified restart file.
        %>
        count = [];
        %>
        %>   \param[in] ndim            :   The scalar MATLAB integer containing the number of
        %>                                  dimensions of the domain of the objective function.
        %>
        ndim = [];
        %>
        %>  \param[in]  domainAxisName  :   The vector of MATLAB strings of size ``ndim`` containing
    ...
    methods(Access = public)
        ...
        %>  \brief
        %>  Return a scalar object of class ``pm.sampling.FileContentsRestart``.<br>
