...
%>                                      The following wildcards can be used within the specified ``pattern``:<br>
%>                                      <ol>
...
function fileList = findfile(self, ftype, pattern)
    ...
    if isfile(pattern)
        ...
        if  isempty(fileList)
            ...
            if contains(ftype, "restart")
                msg = msg ...
                    + "For restart files, you can set the simulation specification ``outputRestartFileFormat`` to" + newline ...
                    + newline ...
                    + pm.io.tab() + "spec.outputRestartFileFormat = ""ascii"";" + newline ...
                    + newline ...
            ...
            elseif contains(ftype, "chain")
                msg = msg ...
                    + "For chain files, you can set the simulation specification ``outputChainFileFormat`` to" + newline ...
                    + newline ...
                    + pm.io.tab() + "spec.outputChainFileFormat = ""ascii"";" + newline ...
                    + newline ...
                    + "to generate ASCII-format MATLAB-readable " + ftype + " files." ...
                    + newline ...
                    ;
    ...
    if ~self.silent
        disp(string(length(fileList)) + " " + ftype + " files were detected matching pattern: """ +  pattern + """");
    end
