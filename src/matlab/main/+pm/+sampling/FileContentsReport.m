        ...
        function self = FileContentsReport(file, silent, method)
            ...
            try
                for parcond = ["sameeff", "zeroeff"]
                    if  strcmp(parcond, "sameeff")
                        titletext = "Strong Scaling: Current-Efficiency Sampling";
                    elseif strcmp(parcond, "zeroeff")
                        titletext = "Strong Scaling: Zero-Efficiency Sampling";
                    else
                        error   ( newline ...
                                + "Internal ParaMonte library error occurred." + newline ...
                                + "Please report this error to the ParaMonte library developers." + newline ...
                                + newline ...
                                );
                    end
                    ...
                    pm.vis.PlotLineScatter  ( self.stats.parallelism.speedup.scaling.strong.(parcond).df ...
                                            ...
                                            , "title", {"enabled", true, "titletext", titletext} ...
                                            , "plot", {"linewidth", 2.5} ...
                                            , silent_kws{:} ...
                                            );
                end
