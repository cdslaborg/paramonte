        ...
        function self = FileContentsReport(file, silent, method)
            ...
            try
                for parcond = ["sameeff", "zeroeff"]
                    ...
                    pm.vis.PlotLineScatter  ( self.stats.parallelism.speedup.scaling.strong.(parcond).value ...
                ...
                warning ( newline ...
                        ...
                        + "It is possible that the component ``stats.parallelism.speedup.scaling.strong.(parcond).value`` of the " + newline ...
