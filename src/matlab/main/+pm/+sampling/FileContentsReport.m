        ...
        function self = FileContentsReport(file, silent, method)
            ...
            try
                for parcond = ["sameeff", "zeroeff"]
                    ...
                    self.stats.parallelism.scaling.strong.(parcond).vis.lineScatter = ...
                    pm.vis.PlotLineScatter  ( self.stats.parallelism.scaling.strong.(parcond).value ...
                ...
                warning ( newline ...
                        ...
                        + "It is possible that the component ``stats.parallelism.scaling.strong.(parcond).value`` of the " + newline ...
            ...
            try
                ...
                dfpc = self.stats.parallelism.process.contribution.count.current.value;
                dfpc.cyclicGeometricFit = cgfit ( dfpc.processID ...
                                                , self.stats.parallelism.process.contribution.count.current.fit.value.successProb ...
                                                , self.stats.parallelism.process.contribution.count.current.fit.value.normFac ...
                                                , self.stats.parallelism.process.count.current.value.Var1 ...
                                                );
