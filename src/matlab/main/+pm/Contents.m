...
%>
%>  \details
%>  This interface group is the entry point to all **MATLAB-style interfaces** to the ParaDRAM samplers of mathematical density functions.<br>
...
%>  \param[in]  input       :   The input scalar pointer of type `char` representing the null-terminated MATLAB string
...
%>
%>  \example{himmelblau}
%>  \include{lineno} example/pm_sampling/himmelblau/main.m
%>  \inputfile{mvn, input.nml, example specifications namelist input file}
%>  \include{lineno} example/pm_sampling/mvn/input.nml
