...
%>  intrinsic functions.
%>
classdef Contour3 < pm.vis.tile.Tile
    methods(Access = public)
        ...
        %>
        %>  \return
        %>  An object of [pm.vis.tile.Contour3](@ref Contour3) class.
        %>
        %>  \interface{Contour3}
        %>  \code{.m}
        ...
        function self = Contour3(dfref, varargin)
            ...
            self = self@pm.vis.tile.Tile(pm.vis.subplot.Contour3(dfref), varargin{:});
        end
    end
end