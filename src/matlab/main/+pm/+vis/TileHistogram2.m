%>  \brief
%>  This is the [pm.vis.TileHistogram2](@ref TileHistogram2) class for generating
...
classdef TileHistogram2 < pm.vis.Tile
    ...
    methods(Access = public)
        ...
        %>  \brief
        %>  Construct and return an object of class [pm.vis.TileHistogram2](@ref TileHistogram2).<br>
        %>
        %>  \details
        %>  This is the constructor of the class [pm.vis.TileHistogram2](@ref TileHistogram2).<br>
        %>
        ...
        %>
        %>  \return
        %>  ``self``                :   An object of [pm.vis.TileHistogram2](@ref TileHistogram2) class.<br>
        %>
