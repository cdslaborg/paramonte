%>  \brief
%>  This is the [pm.vis.TileContour3](@ref TileContour3) class for generating
...
classdef TileContour3 < pm.vis.Tile
    ...
    methods(Access = public)
        ...
        %>  \brief
        %>  Construct and return an object of class [pm.vis.TileContour3](@ref TileContour3).<br>
        %>
        %>  \details
        %>  This is the constructor of the class [pm.vis.TileContour3](@ref TileContour3).<br>
        %>
        ...
        %>
        %>  \return
        %>  ``self``                :   An object of [pm.vis.TileContour3](@ref TileContour3) class.<br>
        %>
