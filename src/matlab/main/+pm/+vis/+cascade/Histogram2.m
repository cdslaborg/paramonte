...
%>  instances of 3-dimensional Histogram2 [Cascade visualizations](@ref Cascade)
...
classdef Histogram2 < pm.vis.cascade.Cascade
    methods(Access = public)
        %>  \brief
        %>  Construct and return an object of class [pm.vis.cascade.Histogram2](@ref Histogram2).<br>
        %>
        ...
        function self = Histogram2(dfref, varargin)
            ...
            self = self@pm.vis.cascade.Cascade(pm.vis.plot.Histogram2(dfref), varargin{:});
        end
    end
end