...
classdef LineScatter3 < pm.vis.cascade.Cascade
    methods(Access = public)
        %>  \brief
        %>  Construct and return an object of class [pm.vis.cascade.LineScatter3](@ref LineScatter3).<br>
        %>
        ...
        %>
        %>  \return
        %>  ``self``                :   The output scalar object of class [pm.vis.cascade.LineScatter3](@ref LineScatter3).<br>
        %>
        %>  \note
