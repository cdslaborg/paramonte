...
///
/// [⛓](#ParaMonteCDocumentation)
/// \section ParaMonteCDocumentation ParaMonte C Documentation Website
///
...
///
/// [⛓](#ParaMonteCModules)
/// \section ParaMonteCModules ParaMonte C Library Modules
///
...
///
/// [⛓](#ParaMonteCNamingConventions)
/// \section ParaMonteCNamingConventions ParaMonte C Naming Conventions
///
/// +   The **CamelCase** naming style is enforced throughout the ParaMonte C library.
///
/// [⛓⛓](#ParaMonteCNamingConventionsVariables)
/// \subsection ParaMonteCNamingConventionsVariables ParaMonte C Naming Conventions: Variables
///
...
///
/// [⛓⛓](#ParaMonteCNamingConventionsProcedures)
/// \subsection ParaMonteCNamingConventionsProcedures ParaMonte C Naming Conventions: Procedures
///
...
///
/// [⛓](#ParaMonteCAbbreviationGuidlines)
/// \section ParaMonteCAbbreviationGuidlines ParaMonte C Abbreviation Guidelines
///
...
///
/// [⛓](#ParaMonteCDeveloperWarnings)
/// \section ParaMonteCDeveloperWarnings ParaMonte C Developer Guidelines and Warnings
///
/// The ParaMonte C library development and guidelines are summarized in
/// <a href="https://github.com/cdslaborg/paramonte/blob/main/src/c/CONTRIBUTING.md" target="_blank">CONTRIBUTING.md</a>.
///
/// [⛓](#ParaMonteCDocumentationGuidelines)
/// \section ParaMonteCDocumentationGuidelines ParaMonte C Documentation Guidelines
///
...
///         Example: See [below](#example-ParaMonteCDocumentationGuidelines).<br>
...
///     \example{ParaMonteCDocumentationGuidelines}
...
///
/// [⛓](#ParaMonteCExamples)
/// \section ParaMonteCExamples ParaMonte C Language Examples
///
...
///
/// [⛓](#ParaMonteCBenchmarks)
/// \section ParaMonteCBenchmarks ParaMonte C Language Benchmarks
///
...
///
/// [⛓](#ParaMonteCDocumentationTroubleshooting)
/// \section ParaMonteCDocumentationTroubleshooting ParaMonte C Documentation Troubleshooting
///
/// <ol>
